...
INDEX idx_rol(rol), INDEX idx_activo(activo)
...
INDEX idx_pc(pc_origen), INDEX idx_estado(estado), INDEX idx_fecha(fecha)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO configuracion(clave,valor) VALUES('version_sistema','1.1.0') ON DUPLICATE KEY UPDATE valor=VALUES(valor);
INSERT INTO configuracion(clave,valor) VALUES('tickets_por_pagina','10') ON DUPLICATE KEY UPDATE valor=VALUES(valor);
